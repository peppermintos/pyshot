...
class Shotter:
    ...
    def shot_callback(self, widget):
        ...
        t = threading.Thread(group=None, target=self.take_screenie, name="screenshot",
                             args=(should_hide, delay), kwargs={})
        t.start()
    ...
    def save_image(self, widget):
        ...
        try:
            ...
            md = gtk.MessageDialog(parent=self.window, flags=0, type=gtk.MESSAGE_ERROR, buttons=gtk.BUTTONS_OK,
                                   message_format=msg)
